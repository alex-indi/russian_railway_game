...
CONTRACTS = [
    ...
    {"id": "P3", "origin": "B", "destination": "A", "max_rounds": 3, "goods_1": "Желтый", "qty_1": 6, "goods_2": None,
     "qty_2": 0, "goods_3": None, "qty_3": 0},
    {"id": "P4", "origin": "A", "destination": "B", "max_rounds": 3, "goods_1": "Синий", "qty_1": 4, "goods_2": None,
     "qty_2": 0, "goods_3": None, "qty_3": 0},
    {"id": "P5", "origin": "B", "destination": "A", "max_rounds": 3, "goods_1": "Зеленый", "qty_1": 6, "goods_2": None,
     "qty_2": 0, "goods_3": None, "qty_3": 0},
    {"id": "P6", "origin": "B", "destination": "A", "max_rounds": 3, "goods_1": "Уголь", "qty_1": 6, "goods_2": None,
     "qty_2": 0, "goods_3": None, "qty_3": 0},
    ...
    {"id": "M5", "origin": "B", "destination": "A", "max_rounds": 2, "goods_1": "Синий", "qty_1": 6, "goods_2": "Уголь",
     "qty_2": 4, "goods_3": None, "qty_3": 0},
    {"id": "M6", "origin": "A", "destination": "B", "max_rounds": 2, "goods_1": "Уголь", "qty_1": 10,
     "goods_2": "Зеленый", "qty_2": 4, "goods_3": None, "qty_3": 0},
    {"id": "M7", "origin": "B", "destination": "A", "max_rounds": 2, "goods_1": "Щебень", "qty_1": 10,
     "goods_2": "Желтый", "qty_2": 6, "goods_3": None, "qty_3": 0},
    ...
    {"id": "S1", "origin": "A", "destination": "B", "max_rounds": 1, "goods_1": "Металл", "qty_1": 1,
     "goods_2": "Уголь", "qty_2": 6, "goods_3": "Синий", "qty_3": 6},
    ...
    {"id": "S3", "origin": "A", "destination": "B", "max_rounds": 1, "goods_1": "Зеленый", "qty_1": 6,
     "goods_2": "Синий", "qty_2": 6, "goods_3": "Металл", "qty_3": 1},
...
EVENTS = [
    ...
    {"id": "P03", "group": "Погодные", "name": "Туман", "description": "−1 единицы времени из-за плохой видимости."},
    ...
    {"id": "P09", "group": "Погодные", "name": "Снегопад",
     "description": "−1 единица времени. Дополнительная проверка технического состояния всего состава."},
    {"id": "P10", "group": "Погодные", "name": "Гололёд", "description": "Погрузка и разгрузка теперь занимает 2 единицы времени вместо одной."},
    ...
    {"id": "H04", "group": "Человеческий фактор", "name": "Болезнь инженера",
